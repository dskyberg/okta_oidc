...
fn init_resource() -> Resource {
    ...
    let provided = Resource::new(vec![
        KeyValue::new(otel_resource::SERVICE_NAME, "okta_oidc"),
        KeyValue::new(otel_resource::SERVICE_NAMESPACE, "okta_oidc"),
...
fn init_tracer(endpoint: &str, resource: Resource) -> sdktrace::Tracer {
